...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO abogados (matricula, nombre, apellido1, apellido2, calle, colonia, numero) VALUES (?,?, ?, ?, ?, ?, ?)";

    // Prepara la consulta
    $stmt = $conec->prepare($sql);

    if ($stmt) {
        $stmt->bind_param("ssssssi", $matricula, $nombre, $apellido1, $apellido2, $calle, $colonia, $numero);
    ...
    <div class="container mt-5">
        ...
        <form action="abogado.php" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="matricula" name="matricula" maxlength="15" required>
            </div>
            <div class="mb-3">
